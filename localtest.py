...
model_finetuned = wandb.restore("model.h5",run_path="/home/akilles/projects/Train-VGG16/wandb/latest-run/run-4ebqmk10.wandb")
model = tf.keras.applications.VGG16()
model.load_weights(model_finetuned.name)
