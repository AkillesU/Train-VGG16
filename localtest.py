...
model_finetuned1 = tf.keras.models.load_model(filepath=" checkpoints/train_fully4000")

#Loading finetuned model
model_finetuned2 = tf.keras.models.load_model(filepath=" checkpoints/train_fully16000")
