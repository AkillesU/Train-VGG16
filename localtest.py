...
model_finetuned3 = tf.keras.models.load_model(filepath="full_train31970epoch02")

#Loading finetuned model
model_finetuned1 = tf.keras.models.load_model(filepath="full_train32000epoch01")

#Loading finetuned model
model_finetuned2 = tf.keras.models.load_model(filepath="full_train20000epoch01")
